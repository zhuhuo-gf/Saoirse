...
0.4.2 已形成“小 Codex”初版工作流：项目、对话、终端、Diff/检查点、Git、技能、MCP、权限策略与外观 DIY 统一在一个工作台中。Harness 设置改为独立宽屏窗口，解决窄窗口下中文竖排和选项拥挤的问题；默认背景为海军风裙装、完整露出腿部与鞋子的鲸灵海底观测站全身构图。GitHub Release 更新地址已经接入，正式公开分发前仍建议配置代码签名证书。
